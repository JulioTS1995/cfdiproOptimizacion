...
<html>
  ...
  <body>
    ...
    <center>
      <form method="post" action="2_remisiones_tracking_sucursal.php" enctype="multipart/form-data">
        <fieldset>
...
<!-- http://67.205.112.109/cfdipro/2_remisiones_tracking_fechas.php?prefijodb=prueba_ -->