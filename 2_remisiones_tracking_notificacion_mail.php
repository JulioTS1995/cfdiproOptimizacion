<?php
    ...
    //if (isset($_POST['hasta']))
		//  $fechah = $_POST['hasta'];
			...
			$mensaje = '
				<h2>Viajes:  Ultimo Estatus de Tracking</h2>
	...
	while ($rowSQL=mysql_fetch_array($runSQL)){
		...
		//Marca error en la linea 217 [Undefined variable: fecha00] ¿se podria utilizar $fecha? error posible por cambio de formato
		if(($fecha00 >= $fi2) AND ($fecha00 <= $nuevafecha_fin)){
			...
			try {
				...
				$mail->setFrom($v_mail_from, 'Tractosoft'); 
