...
//Linea original:
//$linea = exec("C:\\xampp\\htdocs\\cfdipro\\".$nombrebat." ".$_REQUEST["id"]);

//Linea modificada:
$linea = exec("C:\\xampp\\htdocs\\cfdipro\\".$nombrebat." ".$_REQUEST["id"]." ".$nombrereporte);

if ($debug == 1) {
	echo $linea;
	
	$lineasalida = "C:\\xampp\\htdocs\\cfdipro\\".$nombrebat." ".$_REQUEST["id"]." ".$nombrereporte;
	echo $lineasalida;
}
