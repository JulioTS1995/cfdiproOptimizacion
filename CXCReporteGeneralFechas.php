		...
		<div class="row">
			...
			<br>
				<div id="encabezadoform" style="text-align:center">
				  <h2 class="font-weight-bold" style="text-align: center;color:#0059b3; line-height: 100px;">Reporte General CXC</h2>
				</div>
				<br>
				<center>
					<form method="post" action="CXCReporteGeneral.php" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<label>Moneda:
							<select class="form-control inputdefault" name="moneda" id="moneda">
