    ...
    <div id = "container1" style = "width: 80%; margin: 0 auto; text-align:center;" >
			...
			<div class="col-lg-12">
			  ...
			  <table class="table table-hover table-responsive table-condensed" id="table">
				...
				<?php
					...
					$resSQL="SELECT Creado, RemisionOperador, XFolio, Remitente, Destinatario FROM ".$prefijobd."Remisiones WHERE Date(Creado)Between '".$_POST["fechai"]." 00:00:00' AND '".$_POST["fechaf"]." 23:59:59' AND CargoACliente_RID = '".$cliente."' ORDER BY Creado;";
		...
		<div class="row">
			<div class="col-md-12" style="text-align:left">
				<a href="FormatoConcentrado315Excel.php?fechai=<?php echo $fecha_inicio; ?>&fechaf=<?php echo $fecha_fin; ?>&prefijodb=<?php echo $prefijobd; ?>&cliente=<?php echo $cliente; ?>"><button type="button" class="btn btn-success">Exporta a Excel</button></a>
			</div>
		</div>
		<br>
		<br>
