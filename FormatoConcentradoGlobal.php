...
if ($_POST['circuito']!='0'){
	$qryExtra = " AND Circuito2_RID = '".$_POST['circuito']."' ";
}
...
<title>Concentrado Global</title>
    ...
    <div id = "container1" style = "width: 80%; margin: 0 auto; text-align:center;" >
        <div id="contenedor2" style="overflow:hidden;">
                ...
                <div id="2" style="float: left; width: 100%; text-align:left;">
                    <h1 class="font-weight-bold" style="text-align: left;color:#0059b3; line-height: 100px;"><strong>Formato Concentrado Global</h1>
                </div>
			...
			<div class="col-lg-12">
			  ...
			  <table class="table table-hover table-responsive table-condensed" id="table">
				...
				<?php
					...
					$resSQL="SELECT Creado, DescripcionProducto, XFolio, Remitente, Destinatario, Sello, Firma, Operador_RID FROM ".$prefijobd."Remisiones WHERE 
					Date(Creado)Between '".$_POST["fechai"]." 00:00:00' AND '".$_POST["fechaf"]." 23:59:59' 
					AND CargoACliente_RID = '".$cliente."' $qryExtra GROUP BY Creado;";
					...
					while ($rowSQL=mysqli_fetch_array($runSQL)){
						...
						$ticket = $rowSQL['DescripcionProducto'];
		...
		<div class="row">
			<div class="col-md-12" style="text-align:left">
				<a href="FormatoConcentradoGlobalExcel.php?fechai=<?php echo $fecha_inicio; ?>&fechaf=<?php echo $fecha_fin; ?>&prefijodb=<?php echo $prefijobd; ?>&cliente=<?php echo $cliente; ?>&circuito=<?php echo $circuito; ?>"><button type="button" class="btn btn-success">Exporta a Excel</button></a>
			</div>
		</div>
		<br>
		<br>
