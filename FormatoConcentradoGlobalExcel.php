...
if ($_GET['circuito']!='0'){
	$qryExtra = " AND Circuito2_RID = '".$_GET['circuito']."' ";
}
...
$resSQL="SELECT Creado, DescripcionProducto, XFolio, Remitente, Destinatario, Sello, Firma, Operador_RID FROM ".$prefijobd."Remisiones WHERE Date(Creado)Between '".$_GET["fechai"]." 00:00:00' AND '".$_GET["fechaf"]." 23:59:59' AND CargoACliente_RID = '".$_GET["cliente"]."' $qryExtra GROUP BY Creado;";
