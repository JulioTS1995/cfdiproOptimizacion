...
$resSQL="SELECT Creado, RemisionOperador, XFolio, Remitente, Destinatario, Sello, Firma, Operador_RID FROM ".$prefijobd."Remisiones WHERE Date(Creado)Between '".$_GET["fechai"]." 00:00:00' AND '".$_GET["fechaf"]." 23:59:59' AND CargoACliente_RID = '".$_GET["cliente"]."' $qryExtra GROUP BY Creado;";
