...
if($numRenglones==0){// IMPORTACION FALLIDA: RFC NO REGISTRADO
    ...
    foreach ($xml2->xpath('//cfdi:Conceptos//cfdi:Concepto') as $Concepto) {
        ...
        if($numRenglones!=0 && $tipoComprobante=='I'){
                $queryP = "INSERT INTO ".$prefijobd."ComprasSub(ID,Cantidad,Nombre,Importe,PrecioUnitario,FolioSub_REN,FolioSub_RID,Descuento,TasaIVA,ImporteIVA,TasaRetencion,ImporteRetencion, Importada) values
                ('$new2id','$cantidad','$descripcion','$importe','$valorUnitario','Compras','$idPrincipal','$descuento','".$IVA."','".$importeIVA."','".$Retencion."','".$importeRetencion."', '1');";
                    //die($queryP);
  ...
  <form method="post" enctype="multipart/form-data">
    <div class="form-group">
        ...
        //mysql_select_db($database_cfdi, $cnx_cfdi);
                    $resSQL = "SELECT ID,Serie, Oficina FROM ".$prefijobd."Oficinas WHERE EsComp=1 AND Sucursal_RID = ".$sucursal." ORDER BY Oficina";
