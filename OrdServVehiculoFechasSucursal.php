		...
		<div class="row">
			...
			<br>
				<div id="encabezadoform" style="text-align:center">
				  <h2 class="font-weight-bold" style="text-align: center;color:#0059b3; line-height: 100px;">ORDENES DE SERVICIO POR VEHICULO</h2>
				</div>
				<br>
				<center>
					<form method="post" action="OrdServVehiculo.php" enctype="multipart/form-data">
				...
				mysqli_select_db($cnx_cfdi2,$database_cfdi);
						...
						$resSQL = "SELECT ID,Unidad FROM ".$_GET["prefijodb"]."Unidades WHERE Sucursal_RID = ".$sucursal." ORDER BY Unidad";
