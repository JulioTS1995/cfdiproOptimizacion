...
<div id = "container1" style = "width: 80%; margin: 0 auto; text-align:center;" >
	...
	<div class="col-md-12" style="text-align:left">
		<a href="OrdServVehiculoExcelSucursal.php?fechai=<?php echo $fechaInicio; ?>&fechaf=<?php echo $fechaFin; ?>&prefijodb=<?php echo $prefijobd; ?>&unidad=<?php echo $unidadID; ?>&sucursal=<?php echo $sucursal; ?>"><button type="button" class="btn btn-success">Exporta a Excel</button></a>
	</div>
	<br>
	<br>
	<div class="col-md-12" style="text-align:left">
		<a href="OrdServVehiculoPdfSucursal.php?fechai=<?php echo $fechaInicio; ?>&fechaf=<?php echo $fechaFin; ?>&prefijodb=<?php echo $prefijobd; ?>&unidad=<?php echo $unidadID; ?>&sucursal=<?php echo $sucursal; ?>&emisor=<?php echo $emisor; ?>"><button type="button" class="btn btn-danger">Exporta a PDF</button></a>
	</div>
</div>
