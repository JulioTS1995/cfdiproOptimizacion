...
.style3 {
	...
	<body>  
	  <form action="reporte_cobranza_pdf_cliente_sucursal.php" method="post" target="_blank">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="invisible">
					...
					<input type="text" name="sucursal" id="sucursal" class="form-control btn btn-primary btn-lg"  type="hidden" value="<?php echo $sucursal; ?>">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label>Cliente:</label>
						<select class="form-control" name="cliente" id="cliente">
							<option value="0">- Seleccione -</option>
								<?php 
									//Buscar Clientes 
									$sql2 = "SELECT ID, RazonSocial FROM ".$prefijobd."clientes WHERE Sucursal_RID = ".$sucursal." ORDER BY RazonSocial";
