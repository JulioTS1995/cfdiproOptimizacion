...
<body>  
	<div class="col-md-10 col-md-offset-1">
		<div class="row">
			<div class="col-md-12">
				<h2><b>Estado de Cuenta</b></h2>
				<h4>Fecha: <?php echo $fecha2; ?></h4>
			</div>
			<div class="col-md-6">
				<a href="Reporte_edo_cuenta_clientes_mail_sucursal.php?prefijobd=<?php echo $prefijobd; ?>"><button type="button" class="btn btn-info btn-lg btn-block">Enviar Mail</button></a>
			</div>
			<div class="col-md-6">
				<a href="Reporte_edo_cuenta_clientes_excel_sucursal.php?prefijobd=<?php echo $prefijobd; ?>"><button type="button" class="btn btn-success btn-lg btn-block">Exportar a Excel</button></a>
			</div>
		</div>
		<br>
		...
		<div class="row">
            <div class="col-lg-12" style="heigth:1200; overflow:scroll;">
			 ...
			 <div class="col-lg-12">
				<h3><b>Total Clientes: <?php echo $total_clientes; ?></b></h3>
			 </div>
		</div>
...
//http://ts-c4.ddns.net/cfdipro/Reporte_edo_cuenta_clientes_lukar.php?prefijobd=lukar_
