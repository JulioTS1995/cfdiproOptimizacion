...
<div id="container">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<form action="abonos_cfdiuuid_relacionado_tipo_2.php" name="form1" method="post" enctype="application/x-www-form-urlencoded" id="form1">
...
//http://localhost/cfdipro/abonos_cfdiuuid_relacionado_tipo.php?prefijodb=prueba_&id=3822282&xfolio=PR243&tipo=04
