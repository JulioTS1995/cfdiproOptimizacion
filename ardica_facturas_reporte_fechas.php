		...
		<div class="row">
			...
			<br>
				<div id="encabezadoform" style="text-align:center">
				  <h2 class="font-weight-bold" style="text-align: center;color:#0059b3; line-height: 100px;">Reporte de Ventas por Periodo <small style="color:#4da6ff; ">ARDICA</small></h2>
				</div>
				<br>
				<center>
					<form method="post" action="ardica_facturas_reporte.php" enctype="multipart/form-data">
...
<!--http://174.142.204.88//cfdipro/ardica_facturas_reporte_fechas.php?prefijodb=ardica_ -->