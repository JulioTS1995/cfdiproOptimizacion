...
/*ces_facturadetalle.php
 * 
 * Sirve para imprimir las distintas facturas de CES dependiendo del pais
 * 
 */
...
$archivo_bat = "ces_facturadetalle.bat";
...
$qryfolio = "SELECT folio FROM " . $prefijobd . "factura WHERE id = " . $_REQUEST["id"];
...
$linea = passthru("C:\\xampp\\htdocs\\cfdipro\\".$archivo_bat." ".$_REQUEST["id"]." ".$nombrereporte." ".$prefijobd);

$rutadescarga = $RutaServer."factura_" .$id. ".pdf";
...
?>
	<form name="parametros" method="post" action="ces_facturadetalle.php">
