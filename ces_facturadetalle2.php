...
$archivo_bat = "ces_facturadetalle2.bat";
...
$linea = exec("C:\\xampp\\htdocs\\cfdipro\\".$archivo_bat." ".$id." ".$nombrereporte." ".$prefijobd);
...
?>
	<form name="parametros" method="post" action="ces_facturadetalle2.php">
