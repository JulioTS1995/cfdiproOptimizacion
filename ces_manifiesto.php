...
/*ces_manifiesto.php
 * 
 * Sirve para imprimir los distintos manifiestos de CES dependiendo del pais
 * 
 */
...
$archivo_bat = "ces_manifiesto.bat";
...
?>
	<form name="parametros" method="post" action="ces_manifiesto.php">
