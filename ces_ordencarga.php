...
/*ces_ordencarga.php
 * 
 * Sirve para imprimir las distintas orden de carga de CES dependiendo del pais
 * 
 */
...
$archivo_bat = "ces_ordencarga.bat";
...
if ($debug == 1) {
	echo "C:\\xampp\\htdocs\\cfdipro\\".$archivo_bat." ".$_REQUEST["id"]." ".$nombrereporte." ".$prefijobd;
;
}
...
?>
	<form name="parametros" method="post" action="ces_ordencarga.php">
