...
//Inicio la transaccion
	...
	if($tiporelacion2=='066'){
		...
		echo "<h2>Remision Relacionada: <b>".$xfoliosub."</b> Se removio de la Factura: <b>".$xfolio2."</b></h2>";
	}else {
				$resSQL01 = "SELECT * FROM " . $prefijobd . "factura WHERE ID = ".$idfoliosub;
		$runSQL01 = mysql_query($resSQL01, $cnx_cfdi);
		$rowSQL01 = mysql_fetch_assoc($runSQL01);
		...
		$sql_update2 = "UPDATE " . $prefijobd . "factura SET 
			TipoRelacion = ''
			WHERE ID = ".$idfoliosub;
	...
	//Limpiar campo TipoRelacion de la Factura
	$res55 = "SELECT * FROM " . $prefijobd . "facturauuidrelacionadosub WHERE FolioSub_RID = ".$idfoliosub;
	...
	if($total_reg > 0){
		...
		$sql_update55 = "UPDATE " . $prefijobd . "factura SET 
