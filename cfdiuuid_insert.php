...
//Inicio la transaccion
	...
	$resSQL1 = "SELECT COUNT(*) as total FROM " . $prefijodb . "facturauuidrelacionadosub WHERE FolioSub_RID = ".$idfactura." AND TipoRelacion='04'";
	...
	if($v_total == 0){
		...
		$sql = "INSERT INTO " . $prefijodb . "facturauuidrelacionadosub (ID, cfdiuuidRelacionado, XFolio, FolioSub_RID, FolioSub_REN, FolioSub_RMA, BASTIMESTAMP, TipoRelacion) VALUES (". $newid .", '". $cfdiuuid ."', '". $xfolio ."', ". $idfactura .", 'Factura', 'FolioSubUUIDRelacionado', '".$fecha."','04')";
