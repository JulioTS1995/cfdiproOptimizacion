...
//Inicio la transaccion
	...
	$resSQL1 = "SELECT COUNT(*) as total FROM " . $prefijodb . "facturauuidrelacionadosub WHERE FolioSub_RID = ".$idfactura;
	...
	if($v_total == 0){
		...
		$sql = "INSERT INTO " . $prefijodb . "facturauuidrelacionadosub (ID, cfdiuuidRelacionado, XFolio, FolioSub_RID, FolioSub_REN, FolioSub_RMA, BASTIMESTAMP) VALUES (". $newid .", '". $cfdiuuid ."', '". $xfolio ."', ". $idfactura .", 'Factura', 'FolioSubUUIDRelacionado', '".$fecha."')";
