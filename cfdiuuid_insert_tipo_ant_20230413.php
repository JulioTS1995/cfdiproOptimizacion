...
//Inicio la transaccion
	...
	if($v_total == 0){
		...
		$sql = "INSERT INTO " . $prefijodb . "facturauuidrelacionadosub (ID, cfdiuuidRelacionado, XFolio, FolioSub_RID, FolioSub_REN, FolioSub_RMA, BASTIMESTAMP, TipoRelacion, TipoRelacion2) VALUES (". $newid .", '". $cfdiuuid ."', '". $xfolio ."', ". $idfactura .", 'Factura', 'FolioSubUUIDRelacionado', '".$fecha."','".$tiporelacion."','".$tiporelacion2."')";
		...
		if($tiporelacion2 == '066'){
			...
			//Actualizar campo TipoRelacion en Factura
			$sql_update2 = "UPDATE " . $prefijodb . "factura SET 
			TipoRelacion = '".$tiporelacion."'
			WHERE ID = ".$idfactura;
			
			mysql_query($sql_update2,$cnx_cfdi);
			
			echo "<h1>Remision ".$xfolio."  Anexado con Exito a Factura: ".$facturaorigen."</h1>";
		} else {
			//Actualizar Sustituida Por en Factura Seleccionada
