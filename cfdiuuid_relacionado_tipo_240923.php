...
<div id="container">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<form action="cfdiuuid_relacionado_tipo_2.php" name="form1" method="post" enctype="application/x-www-form-urlencoded" id="form1">
...
//http://localhost/cfdipro/cfdiuuid_relacionado_tipo_sel.php?prefijodb=prueba_&id=3822282&cliente=658215&xfolio=PR243&tipo=04
