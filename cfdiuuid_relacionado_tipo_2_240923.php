...
<div class="container" style="margin-top: 0;">
	...
	<div class="row">
		<div class="col-md-12 text-center">
			<h2><b>Factura Seleccionada: <?php echo $xfolio ?></b></h2>
		</div>
	</div>
	<hr>
	<div class="row">
                    ...
                    <tbody>
                            <?php 
								...
								if($tiporelacion ==  '066' || $tiporelacion ==  '05'){
									...
									$resSQLcount = "SELECT COUNT(*) as total FROM " . $prefijobd . "factura WHERE CargoAFactura_RID = " . $idcliente . " AND (cCanceladoT IS NULL OR cCanceladoT='') AND cfdiselloCFD IS NOT NULL AND (cfdiSustituidaPor IS NULL OR cfdiSustituidaPor = '') Order by XFolio ASC";
								...
								if($tiporelacion ==  '066' || $tiporelacion ==  '05'){
									...
									//Busca los registros
									$resSQL1 = "SELECT * FROM " . $prefijobd . "factura WHERE CargoAFactura_RID = " . $idcliente . " AND (cCanceladoT IS NULL OR cCanceladoT='') AND cfdiselloCFD IS NOT NULL AND (cfdiSustituidaPor IS NULL OR cfdiSustituidaPor = '') Order by XFolio ASC";
