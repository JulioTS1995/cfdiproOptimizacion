		...
		<div class="row">
			...
			<br>
				<div id="encabezadoform" style="text-align:center">
				  <h2 class="font-weight-bold" style="text-align: center;color:#0059b3; line-height: 100px;">Reporte de Ventas por Periodo <small style="color:#4da6ff; "></small></h2>
				</div>
				<br>
				<center>
					<form method="post" action="colosos_facturas_reporte.php" enctype="multipart/form-data">
