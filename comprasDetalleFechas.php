	...
	<div class="container">
		<div class="row">
			...
			<br>
				...
				<br>
				<center>
					<form method="post" action="comprasDetalle.php" enctype="multipart/form-data">
...
<!--  https://tractosoft-espejo71.com/cfdipro/comprasDetalleFechas.php?prefijodb=OPTIMIZACION_&emisor=<<LoggedInUsuarios.Oficina.Emisor.ID>>           -->