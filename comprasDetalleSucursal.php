...
<div id = "container1" style = "width: 80%; margin: 0 auto; text-align:center;" >
	<div id="contenedor2" style="overflow:hidden;">
			...
			<div id="2" style="float: left; width: 100%; text-align:left;">
				<h1 class="font-weight-bold" style="text-align: left;color:#0059b3; line-height: 100px;"><strong>Compras Detalle</h1>
			</div>
	...
	<div class="col-md-12" style="text-align:left">
		<a href="comprasDetalleExcelSucursal.php?fechai=<?php echo $fechaInicio; ?>&fechaf=<?php echo $fechaFin; ?>&prefijodb=<?php echo $prefijobd; ?>&proveedor=<?php echo $proveedorID; ?>&sucursal=<?php echo $sucursal; ?>&unidad=<?php echo $unidadID; ?>&producto=<?php echo $productoID; ?>"><button type="button" class="btn btn-success">Exporta a Excel</button></a>
	</div>
	<br>
	<br>
	<div class="col-md-12" style="text-align:left">
		<a href="comprasDetallePdfSucursal.php?fechai=<?php echo $fechaInicio; ?>&fechaf=<?php echo $fechaFin; ?>&prefijodb=<?php echo $prefijobd; ?>&proveedor=<?php echo $proveedorID; ?>&sucursal=<?php echo $sucursal; ?>&emisor=<?php echo $emisor; ?>&unidad=<?php echo $unidadID; ?>&producto=<?php echo $productoID; ?>"><button type="button" class="btn btn-danger">Exporta a PDF</button></a>
	</div>
</div>
<div class="container">
...
<?php
	...
	$resSQL = "SELECT 
		...
		WHERE Date(C.Fecha) BETWEEN ? AND ? AND C.OficinaCompras_RID IN (SELECT ID FROM ".$prefijobd."Oficinas WHERE Sucursal_RID = ".$sucursal." )
		{$filtroProv}
		{$filtroUnidad}
		{$filtroProducto}
		ORDER BY C.XFolio;
