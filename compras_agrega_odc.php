...
<div class="container" style="margin-top: 0;">
	<div style="margin-top: 20px;left: 30%; position:fixed;">
		<h1 class="titulo_1 col-12">Listado de Ordenes de Compra<small class="text-muted"> para Compra: <?php echo $compra_xfolio;  ?></small></h1>
	</div>
...
return $texto;
                    ...
                    $condicion1 = "(Compra IS NULL OR Compra = '') AND ProveedorOC_RID=".$id_proveedor;
                    ...
                    <table class="table table-hover table-responsive table-condensed" id="table">
                        <thead>
                            <tr>
								...
								<th style="vertical-align: middle;text-align:center;">Agregar a Compra</th>
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td style="text-align:center;">
                                    <a href="compras_agrega_odc_proceso.php?id_odc=<?php echo $id_odc;?>&prefijobd=<?php echo $prefijobd;?>&id_compra=<?php echo $id_compra;?>">
