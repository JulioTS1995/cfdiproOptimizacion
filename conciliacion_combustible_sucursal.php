...
';
            ...
            <div id="project">
              ...
              <div>
                ...
                $repotado_importe = 0;
				$repotado_litros = 0;
				$resSQL01 = "SELECT * FROM ".$prefijobd."gastosviajes LEFT JOIN ".$prefijobd."unidades ON ".$prefijobd."gastosviajes.Unidad_RID = ".$prefijobd."unidades.ID LEFT JOIN ".$prefijobd."estaciones ON ".$prefijobd."gastosviajes.Estacion_RID = ".$prefijobd."estaciones.ID WHERE estaciones.Sucursal_RID = ".$sucursal." AND TipoVale = 'Combustible' AND Date(".$prefijobd."gastosviajes.Fecha) Between '".$_POST["fechai"]." 00:00:00' AND '".$_POST["fechaf"]." 23:59:59'".$c_valeemitido.$c_estacion." ORDER BY ".$prefijobd."gastosviajes.Fecha";
				//echo $resSQL01;
				/*$html.='
                    <tr>
