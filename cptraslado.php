...
$resIdCFDI = $_GET['varTimbre']; //Toma el dato que enviaste desde tu sistema que le pusiste el nombre de varTimbre
$resUsrCFDI = $_GET['Usuario']; //Toma el dato que enviaste desde tu sistema que le pusiste el nombre de Usuario
$resSQLcfdi = "SELECT * FROM cargonet_factura WHERE id = $resIdCFDI";
...
$resSQLcontribuyente = "SELECT * FROM cargonet_systemsettings";
...
$resSQLcliente = "SELECT * FROM cargonet_clientes WHERE id = $resIdCliente";
//echo $resSQLcliente;
...
$resSQLestados = "SELECT * FROM cargonet_estados WHERE id = ".$rowSQLcliente['Estado_RID'];
...
$resSQLoficina = "SELECT * FROM cargonet_Oficinas WHERE id = $resIdoficina";
...
$resSQLsub = "SELECT * FROM cargonet_facturassub WHERE FolioSub_RID = $resIdsub";
...
$resRuta ="C:\\TIV\\CFDiPro\\cst\\dt\\tsw\\DirSld\\".$rowSQLcfdi['XFolio'].".fx";
...
fwrite($escribir, "mail server=".$rowSQLcontribuyente['Correo']."\r\n");
fwrite($escribir, "envia=".$rowSQLcontribuyente['Correo']."\r\n");
fwrite($escribir, "para=".$rowSQLcliente['CorreoFactura']."\r\n");
fwrite($escribir, "cc=".$rowSQLcliente['CorreoFactura']."\r\n");
fwrite($escribir, "</Emisor>\r\n");
...
fwrite($escribir, "<Remitente>\r\n");
fwrite($escribir, "r_Rfc=".$rowSQLcfdi['RemitenteRFC']."\r\n");
fwrite($escribir, "r_Nombre=".$rowSQLcfdi['Remitente']."\r\n");
fwrite($escribir, "r_Domicilio=".$rowSQLcfdi['RemitenteDomicilio']."\r\n");
...
fwrite($escribir, "r_TEL=".$rowSQLcfdi['RemitenteTelefono']."\r\n");
fwrite($escribir, "r_email=\r\n");
fwrite($escribir, "r_rNombre=\r\n");
fwrite($escribir, "r_aAPaterno=\r\n");
fwrite($escribir, "r_rAMaterno=\r\n");
fwrite($escribir, "r_CURP=\r\n");
fwrite($escribir, "r_RecogeraEn=\r\n");
fwrite($escribir, "r_PlazaOrigen=".$rowSQLcfdi['RemitenteLocalidad']."\r\n");
fwrite($escribir, "r_EmailFiscal=\r\n");
fwrite($escribir, "</Remitente>\r\n");

fwrite($escribir, "<Destinatario>\r\n");
fwrite($escribir, "d_Rfc=".$rowSQLcfdi['DestinatarioRFC']."\r\n");
fwrite($escribir, "d_Nombre=".$rowSQLcfdi['Destinatario']."\r\n");
fwrite($escribir, "d_Domicilio=".$rowSQLcfdi['DestinatarioDomicilio']."\r\n");
fwrite($escribir, "d_Calle=".$rowSQLcfdi['DestinatarioDomicilio']."\r\n");
fwrite($escribir, "d_noExterior=\r\n");
fwrite($escribir, "d_noInterior=\r\n");
fwrite($escribir, "d_colonia=\r\n");
fwrite($escribir, "d_localidad=".$rowSQLcfdi['DestinatarioLocalidad']."\r\n");
fwrite($escribir, "d_referencia=\r\n");
fwrite($escribir, "d_municipio=\r\n");
fwrite($escribir, "d_estado=\r\n");
fwrite($escribir, "d_pais=MEXICO\r\n");
fwrite($escribir, "d_CODIGOPOSTAL=".$rowSQLcfdi['DestinatarioCodigoPostal']."\r\n");
fwrite($escribir, "d_TEL=".$rowSQLcfdi['DestinatarioTelefono']."\r\n");
fwrite($escribir, "d_email=\r\n");
fwrite($escribir, "d_dNombre=\r\n");
fwrite($escribir, "d_APaterno=\r\n");
fwrite($escribir, "d_AMaterno=\r\n");
fwrite($escribir, "d_CURP=\r\n");
fwrite($escribir, "d_N101=\r\n");
fwrite($escribir, "d_EntregaraEn=\r\n");
fwrite($escribir, "d_PlazaDestino=".$rowSQLcfdi['DestinatarioLocalidad']."\r\n");
fwrite($escribir, "d_EmailFiscal=\r\n");
fwrite($escribir, "</Destinatario>\r\n");
...
fwrite($escribir, "<Detalle>\r\n");
$resNumero = 0;
do{
$resNumero = $resNumero + 1;
fwrite($escribir, "C0".$resNumero."_Col01=".$rowSQLsub['Cantidad']."\r\n");
fwrite($escribir, "C0".$resNumero."_Col02=".$rowSQLsub['Embalaje']."\r\n");
fwrite($escribir, "C0".$resNumero."_Col03=".$rowSQLsub['Descripcion']."\r\n");
fwrite($escribir, "C0".$resNumero."_Col04=".$rowSQLsub['Peso']."\r\n");
fwrite($escribir, "C0".$resNumero."_Col05=".$rowSQLsub['Mt3']."\r\n");
fwrite($escribir, "C0".$resNumero."_Col06=".$rowSQLsub['PesoEstimado']."\r\n");
fwrite($escribir, "C0".$resNumero."_Col07=".$rowSQLsub['Comentario']."\r\n");
}while ($rowSQLsub = mysql_fetch_assoc($runSQLsub));
fwrite($escribir, "</Detalle>\r\n");

fwrite($escribir, "<Transporte>\r\n");
fwrite($escribir, "DOCTO=".$rowSQLcfdi['Documentador']."\r\n");
fwrite($escribir, "</Transporte>\r\n");
...
fwrite($escribir, "SubtotalVisual=".round($rowSQLcfdi['zSubtotal'],2)."\r\n");
$resSuma = $rowSQLcfdi['zSubtotal']+$rowSQLcfdi['zImpuesto'];
fwrite($escribir, "Subtotal2=".round($resSuma,2)."\r\n");
fwrite($escribir, "retencion=".round($rowSQLcfdi['zRetenido'],2)."\r\n");
fwrite($escribir, "Cant_Letra1=\r\n");
fwrite($escribir, "ValorUnitario=".$rowSQLcfdi['CuotaxTon']."\r\n");
fwrite($escribir, "ValorDeclarado=".$rowSQLcfdi['ValorDeclarado']."\r\n");
fwrite($escribir, "Viaje=\r\n");
fwrite($escribir, "Unidad=\r\n");
fwrite($escribir, "PlacasUnidad=\r\n");
fwrite($escribir, "Remolque1=\r\n");
fwrite($escribir, "PlacasRemolque1=\r\n");
fwrite($escribir, "Remolque2=\r\n");
fwrite($escribir, "PlacasRemolque2=\r\n");
fwrite($escribir, "Ingreso=\r\n");
fwrite($escribir, "Personal=\r\n");
fwrite($escribir, "NombrePersonal=\r\n");
fwrite($escribir, "Documento=".$rowSQLcfdi['Documentador']."\r\n");
fwrite($escribir, "Remision=\r\n");
fwrite($escribir, "Linea=\r\n");
fwrite($escribir, "Pedido=\r\n");
fwrite($escribir, "FechaPedido=\r\n");
fwrite($escribir, "Expedicion=".$rowSQLcontribuyente['Ciudad']." ".$rowSQLcontribuyente['Estado']."\r\n");
fwrite($escribir, "TipoCobro=3\r\n");
fwrite($escribir, "ConvenioTonelada=".$rowSQLcfdi['CuotaxTon']."\r\n");
fwrite($escribir, "Pedimento=".$rowSQLcfdi['Pedimento']."\r\n");
fwrite($escribir, "Referencia=".$rowSQLcfdi['Referencia']."\r\n");
fwrite($escribir, "UMedida=".$rowSQLcfdi['UnidadMedida']."\r\n");
fwrite($escribir, "CobroViajeKms=\r\n");
...
fwrite($escribir, "<Cliente>\r\n");
fwrite($escribir, "no_cliente=".$rowSQLcliente['ID']."\r\n");
fwrite($escribir, "RFC=".$rowSQLcliente['RFC']."\r\n");
fwrite($escribir, "nombre=".$rowSQLcliente['RazonSocial']."\r\n");
fwrite($escribir, "domicilio=".$rowSQLcliente['Calle']." "."\r\n");
fwrite($escribir, "noExterior=".$rowSQLcliente['NumeroExterior']."\r\n");
fwrite($escribir, "noInterior=".$rowSQLcliente['NumeroInterior']."\r\n");
fwrite($escribir, "colonia=".$rowSQLcliente['Colonia']."\r\n");
fwrite($escribir, "localidad=".$rowSQLcliente['Ciudad']."\r\n");
...
fwrite($escribir, "Tel=".$rowSQLcliente['Telefono']."\r\n");
fwrite($escribir, "email=".$rowSQLcliente['CorreoFactura']."\r\n");
fwrite($escribir, "cNombre=\r\n");
fwrite($escribir, "APaterno=\r\n");
fwrite($escribir, "AMaterno=\r\n");
fwrite($escribir, "CURP=\r\n");
fwrite($escribir, "N101=\r\n");
fwrite($escribir, "PlazaEmision=\r\n");
fwrite($escribir, "PlazaEmisionEstado=".$rowSQLestados['Estado']."\r\n");
fwrite($escribir, "PlazaClientePaga=\r\n");
fwrite($escribir, "EmailFiscal=".$rowSQLcliente['CorreoFactura']."\r\n");
fwrite($escribir, "</Cliente>\r\n");
fwrite($escribir, "id=".$rowSQLcliente['RFC']."\r\n");
fwrite($escribir, "\r\n");
fwrite($escribir, "</Factura>\r\n");
fclose($escribir);


renombrar_archivo("C:\\TIV\\CFDiPro\\cst\\dt\\tsw\\DirSld\\".$rowSQLcfdi['XFolio'].".fx", "C:\\TIV\\CFDiPro\\cst\\dt\\tsw\\DirSld\\F0".$rowSQLcfdi['XFolio'].".ff");
...
$error = existe("C:\\TIV\\CFDiPro\\cst\\dt\\tsw\\DirEnt\\error\\F0".$rowSQLcfdi['XFolio'].".err");
...
if ($error == true)
	{
		...
		$ar=fopen("C:\\TIV\\CFDiPro\\cst\\dt\\tsw\\DirEnt\\error\\F0".$rowSQLcfdi['XFolio'].".err","r");
		while (!feof($ar))
			{
				$linea=fgets($ar);
		...
		fclose($ar);
		unlink("C:\\TIV\\CFDiPro\\cst\\dt\\tsw\\DirEnt\\error\\F0".$rowSQLcfdi['XFolio'].".err");
	}
	
else{
		//Si la variable $error es igual a false entonces imprime en pantalla esto
		$UpdateFac = "UPDATE cargonet_factura SET FEDocumentador='".$resUsrCFDI."',FECreado=NOW() WHERE ID=".$resIdCFDI;
		$runUpdateFac = mysql_query($UpdateFac, $cnx_cfdi); //Corre la consulta
		echo "Generado con Exito";
		$kk = shell_exec("C:\TIV\MotorImpresion\coremotor.bat ".$resIdCFDI);
		$kk = $kk.shell_exec("C:\\TIV\\EnvioCorreo\\correenvio.bat "."\"1\" \"".$rowSQLcliente['CorreoFactura']."\" \"Nuevo Documento De Transportes JOW  ".$rowSQLcfdi['Referencia']."\" \"Estimado (a) Usuario(a),\\n   Le ha llegado un Nuevo Comprobante Fiscal Digital de Transportes JOW.\\n\\n   Atentamente,\\n   Transportes JOW.\" \"C:\\TIV\\CFDiPro\\cst\\dt\\tsw\\DirEnt\" \"F0".$rowSQLcfdi['XFolio'].".PDF\" \"Factura ".$rowSQLcfdi['XFolio'].".PDF\" \"F0".$rowSQLcfdi['XFolio'].".XML\" \"Factura ".$rowSQLcfdi['XFolio'].".XML\"");
  }
