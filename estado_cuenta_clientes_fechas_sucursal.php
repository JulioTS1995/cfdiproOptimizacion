...
<html>
  <head>
    <title>Estado de cuena por clienets</title>
	...
	<body>
		<div class="col-md-8 col-md-offset-2">
			<div id="encabezadoform">
			  <h1>Descargar Estado de Cuenta</h1>
			</div>
			<center>
			  <form method="post" action="estado_cuenta_clientes_sucursal.php" enctype="multipart/form-data" target="_blank">
