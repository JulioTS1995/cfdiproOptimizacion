      ...
      <h1 style="font-size: 20px;">Estado de Cuenta</h1>';
            ...
            <div id="project">
              ...
              <div>
				...
				$fechaf." 11:59:59' and a.Moneda='".$moneda."' ".$sql_cliente." And a.cCanceladoT IS NULL AND CobranzaSaldo > 0 AND b.Sucursal_RID = ".$sucursal." Group BY a.CargoAFactura_RID, b.RazonSocial, b.DiasCredito 
