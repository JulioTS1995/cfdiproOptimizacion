	...
	while ($fila_exp3=mysql_fetch_array($res_03)){
		...
		if($id_remision_anexada > 0){ //IF_1
			...
			while ($fila_exp4=mysql_fetch_array($res_04)){
				...
				$rem_Permisionario_REN = $fila_exp4['Permisionario_REN'];
				$rem_Permisionario_RID = $fila_exp4['Permisionario_RID'];
				$rem_Permisionario_RMA = $fila_exp4['Permisionario_RMA'];
				if($rem_Permisionario_RID > 0){
					$q_rem_Permisionario_RID = "Permisionario_RID=".$rem_Permisionario_RID.",";
					$q_rem_Permisionario_REN = "Permisionario_REN='".$rem_Permisionario_REN."',";
					$q_rem_Permisionario_RMA = "Permisionario_RMA='".$rem_Permisionario_RMA."',";
				} else {
					$q_rem_Permisionario_RID = "Permisionario_RID=null,";
					$q_rem_Permisionario_REN = "Permisionario_REN=null,";
					$q_rem_Permisionario_RMA = "Permisionario_RMA=null,";
				}
			...
			".$q_rem_uDolly_REN."
			".$q_rem_uDolly_RMA."
			".$q_rem_Permisionario_RID."
			".$q_rem_Permisionario_REN."
			".$q_rem_Permisionario_RMA."
			...
			echo "<h2>La Factura se Actualizó con Exito</h2>";
		} else {
