...
//Inicio la transaccion
	...
	while ($fila_exp1=mysql_fetch_array($res_01)){
		...
		mysql_query("DELETE FROM ".$prefijodb."facturassub WHERE ID = ".$id_facturasub);
	...
	$num_rows = mysql_num_rows($res_03);
	...
	if($num_rows > 0){
		...
		echo "<h2>Se realizo la Actualización de Embalaje con Exito</h2>";
