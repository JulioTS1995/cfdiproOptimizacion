...
//Inicio la transaccion
	...
	mysql_query("DELETE FROM ".$prefijodb."facturapartidas WHERE FolioSub_RID = ".$id_factura."");
	...
	while ($fila_exp1=mysql_fetch_array($res_01)){
		...
		while ($fila_exp2=mysql_fetch_array($res_02)){
			...
			$subtotal1 = $fila_exp2['Subtotal1'];
			$isr = $fila_exp2['ISR'];
			$isr_importe = $fila_exp2['ISRImporte'];
			//$descripcion_clave_unidad = $fila_exp2['DescripcionClaveUnidad'];
			...
			if (isset($isr)){
				//Variable definida
				//Insert alterno
				mysql_query("INSERT INTO ".$prefijodb."facturapartidas (ID, BASTIMESTAMP, 
					...
					IVAImporte, Detalle, prodserv33, claveunidad33, prodserv33dsc, Excento, Subtotal1, ISR, ISRImporte, CobranzaSaldo, CobranzaAbonado) 
					VALUES (".$newid.", '".$BASTIMESTAMP."',
					'".$FolioConceptos_REN."',".$FolioConceptos_RID.",'".$Tipo."',".$IVA.",".$RetencionImporte.",
					".$Descuento.",".$Retencion.",".$Importe.",".$DescuentoImporte.",".$Cantidad.",".$PrecioUnitario.",
					".$Subtotal.",'".$ConceptoPartida."','".$FolioSub_REN."',".$FolioSub_RID.",'".$FolioSubPartidas."',
					".$IVAImporte.",'".$Detalle."','".$prodserv33."','".$claveunidad33."','".$prodserv33dsc."',".$excento.",".$subtotal1.",".$isr.",".$isr_importe.",".$Importe.",0)");
			} else {
				...
				mysql_query("INSERT INTO ".$prefijodb."facturapartidas (ID, BASTIMESTAMP, 
					...
					Descuento, Retencion, Importe, DescuentoImporte, Cantidad, PrecioUnitario,
					Subtotal, ConceptoPartida, FolioSub_REN, FolioSub_RID, FolioSub_RMA, 
					IVAImporte, Detalle, prodserv33, claveunidad33, prodserv33dsc, Excento, Subtotal1, CobranzaSaldo, CobranzaAbonado) 
					VALUES (".$newid.", '".$BASTIMESTAMP."',
					'".$FolioConceptos_REN."',".$FolioConceptos_RID.",'".$Tipo."',".$IVA.",".$RetencionImporte.",
					".$Descuento.",".$Retencion.",".$Importe.",".$DescuentoImporte.",".$Cantidad.",".$PrecioUnitario.",
					".$Subtotal.",'".$ConceptoPartida."','".$FolioSub_REN."',".$FolioSub_RID.",'".$FolioSubPartidas."',
					".$IVAImporte.",'".$Detalle."','".$prodserv33."','".$claveunidad33."','".$prodserv33dsc."',".$excento.",".$subtotal1.",".$Importe.",0)");
			}	
