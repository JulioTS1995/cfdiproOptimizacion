...
$sucursal = $_GET["sucursal"];//trae prefijo
...
$queryP = "INSERT INTO ".$prefijobd."Solicitudessub(ID,Mt3,Modificado,PesoVolumen,PesoEstimado,PesoCobrar,BASTIMESTAMP,BASVERSION,Documentador,FolioSub_REN,FolioSub_RID,Cantidad,Embalaje,Peso,Descripcion,ClaveUnidadPeso_REN,ClaveUnidadPeso_RID,
                ...
                NumeroPedimento,UUIDComercioExt,MaterialPeligrosoC,BKG, Movimientos, Sello, Referencia, Orden, Proveedor, OrdenCompra,Dimensiones,ValorMercancia,Moneda,PesoNeto,PesoTara) values
                 ('$newid',0,'$time','0','0','0','$time','0','Tractosoft','Solicitudes', '$remisionID', '$cantidad', '$embalaje', '$peso', '$descripcion','c_ClaveUnidadPeso','$ClaveUnidadPeso','c_ClaveProdServCP','$CodigoProdServ',
                'c_TipoEmbalaje','$idTE','c_MaterialPeligroso','$MaterialPeligroso','c_FraccionArancelaria','$FraccionArancelaria','$item10','$item11','$item18','0','0','0','0','0','0','0','$item12','$item13','$item14','$item15','$item16');";
				 //$newquery=$queryP;
                 $cont++;
                ...
                if (!$runP) {//debug
                    ...
                    die($mensaje);
                     ...
                     /* $query5 = "SELECT * FROM ".$prefijobd."Oficinas WHERE ID ='".$_POST['oficina']."';"; 
                      ...
                      /**/
                      /**/
                      $query6 = "SELECT max(Folio) FROM ".$prefijobd."Solicitudes;"; 
                      //die($query6);
                  ...
                  //inserta Solicitudes
                  $queryP = "INSERT INTO ".$prefijobd."Solicitudes(ID,Folio,BASTIMESTAMP,BASVERSION,CargoASolicitud_REN,CargoASolicitud_RID,Remitente,RemitenteRFC,RemitenteCalle,RemitenteNumExt,
                  RemitenteNumInt,RemitentePais,RemitenteCP,Destinatario,DestinatarioRFC,DestinatarioCalle,DestinatarioNumExt,DestinatarioNumInt,DestinatarioPais,DestinatarioCP,RemitenteColonia_REN,
                  RemitenteColonia_RID,DestinatarioColonia_REN,DestinatarioColonia_RID,RemitenteEstado_REN,RemitenteEstado_RID,DestinatarioEstado_REN,DestinatarioEstado_RID,Creado,RemitenteCitaCarga,
                  DestinatarioCitaCarga,RemitenteLocalidad_REN,RemitenteLocalidad_RID,DestinatarioLocalidad_REN,DestinatarioLocalidad_RID,
                  RemitenteMunicipio_REN,RemitenteMunicipio_RID,DestinatarioMunicipio_REN,DestinatarioMunicipio_RID,RemitenteIdClienteDestino,DestinatarioIdClienteDestino,Prioridad) values
                   ('$remisionID','$folio','$time','1','Clientes','".$_POST['cliente']."','$rem','$remRFC','$remCalle','$remNum1','$remNum2','$remPais',
                   '$remCP','$des','$desRFC','$desCalle','$desNum1','$desNum2','$desPais','$desCP','c_Colonia','$remColonia','c_Colonia',
                   '$desColonia','Estados','$remEstado','Estados','$desEstado','$time','$time','$time','c_Localidad','$remLocalidad','c_Localidad','$desLocalidad','c_Municipio','$remMunicipio','c_Municipio','$desMunicipio','$idOrigen','$idDestino','Normal');";
                   //$newquery=$queryP;
                  $newquery=str_replace("''","NULL",$queryP);
				  //$newquery=str_replace("' '","NULL",$newquery);
                  //die($newquery);
				  ...
				  if ($runP) {
                  echo "<script>alert('Importacion Exitosa, se creo la solicitud ".$folio."');</script>";//Imprime exito
				  }
 }
...
<html>  
 <head>  
  <title>Importar Solicitud</title>
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>  
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" />
 </head>  
 <body>  
  <h3 align="center">Importar Solicitud</h3><br />
