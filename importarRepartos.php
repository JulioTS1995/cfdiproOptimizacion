...
$queryP = "INSERT INTO ".$prefijobd."RemisionesRepartos(ID,Remitente,RemitenteRFC,RemitenteCalle,RemitenteNumInt,RemitenteNumExt,RemitenteEstado_REN,RemitenteEstado_RID,
...
'$desNum1','$desNum2','Estados','$desEstado','c_Localidad','$desLocalidad','c_Municipio','$desMunicipio','c_Colonia','$desColonia','$desCP','$desPais','$remID','$desID','Remisiones','$idRem');";
				 //$newquery=$queryP;
                 $cont++;
