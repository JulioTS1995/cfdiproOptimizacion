    ...
    foreach ($xml2->xpath('//cfdi:Receptor') as $Receptor) {
        ...
        foreach ($xml2->xpath('//cfdi:Conceptos//cfdi:Concepto') as $Concepto) {
            ...
            if ($impuestos->Retenciones) {
                foreach ($impuestos->Retenciones->Retencion as $retencion) {
                    ...
                    $tasaRetencion = $retencion->attributes()['TasaOCuota'];
                    (float)$tasaRetencion=(float)$tasaRetencion*100;
                }
            }
			
			(float)$importeTotal=(float)$importe+(float)$importeIVA-(float)$importeRetencion-(float)$descuento;
        ...
        $new2id =  obtenerSiguienteID($cnx_cfdi2);
                   ...
                   $queryP = "INSERT INTO ".$prefijobd."FacturaPartidas(ID,Cantidad,prodserv33,claveunidad33,Detalle,Importe,PrecioUnitario,IVAImporte,IVA,RetencionImporte,Retencion,FolioSub_REN,FolioSub_RID,ConceptoPartida,Tipo,Subtotal1,Subtotal,DescuentoImporte) values
                    ('$new2id','$cantidad','$claveProdServ','$claveUnidad','$descripcion','$importeTotal','$valorUnitario','".$importeIVA."','".$tasaIVA."','".$importeRetencion."','".$tasaRetencion."','Factura','$newid','FLETE','Flete','$importe','$importe','$descuento');";
						//die($queryP);
            ...
            $TranspInternac=$xml2->xpath('//cfdi:Complemento//cartaporte20:CartaPorte//@TranspInternac | //cfdi:Complemento//cartaporte30:CartaPorte//@TranspInternac | //cfdi:Complemento//cartaporte31:CartaPorte//@TranspInternac');
            $EntradaSalidaMerc=$xml2->xpath('//cfdi:Complemento//cartaporte20:CartaPorte//@EntradaSalidaMerc | //cfdi:Complemento//cartaporte30:CartaPorte//@EntradaSalidaMerc | //cfdi:Complemento//cartaporte31:CartaPorte//@EntradaSalidaMerc');
            $idCCPT=$xml2->xpath('//cfdi:Complemento//cartaporte31:CartaPorte//@IdCCP')[0];
