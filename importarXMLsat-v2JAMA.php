  ...
  if($filename[1] == ('xml')||('XML')){
    ...
    foreach ($xml2->xpath('//cfdi:Receptor') as $Receptor) {
        ...
        $new2id =  obtenerSiguienteID($cnx_cfdi2);
                   ...
                   $queryP = "INSERT INTO ".$prefijobd."FacturaPartidas(ID,Cantidad,prodserv33,claveunidad33,Detalle,Importe,PrecioUnitario,IVAImporte,IVA,RetencionImporte,Retencion,FolioSub_REN,FolioSub_RID,ConceptoPartida,Tipo,Subtotal1,Subtotal,DescuentoImporte) values
                    ('$new2id','$cantidad','$claveProdServ','$claveUnidad','$descripcion','$importeTotal','$valorUnitario','".$importeIVA[$cont3]."','".$IVA[$cont3]."','".$importeRetencion[$cont3]."','".$Retencion[$cont3]."','Factura','$newid','FLETE','Flete','$importe','$importe','$descuento');";
						//die($queryP);
            ...
            $TranspInternac=$xml2->xpath('//cfdi:Complemento//cartaporte20:CartaPorte//@TranspInternac | //cfdi:Complemento//cartaporte30:CartaPorte//@TranspInternac');
            $EntradaSalidaMerc=$xml2->xpath('//cfdi:Complemento//cartaporte20:CartaPorte//@EntradaSalidaMerc | //cfdi:Complemento//cartaporte30:CartaPorte//@EntradaSalidaMerc');
            $idCCPT=$xml2->xpath('//cfdi:Complemento//cartaporte30:CartaPorte//@IdCCP')[0];
            $regimenAduanero=$xml2->xpath('//cfdi:Complemento//cartaporte30:CartaPorte//@RegimenAduanero')[0];
            ...
            foreach ($xml2->xpath('//cartaporte20:Ubicacion | //cartaporte30:Ubicacion') as $Ubicacion) {
                if($cont4==0){
            ...
            foreach ($xml2->xpath('//cartaporte20:Ubicacion//cartaporte20:Domicilio | //cartaporte30:Ubicacion//cartaporte30:Domicilio') as $Domicilio) {
                if ($cont5==0){
            ...
            foreach ($xml2->xpath('//cartaporte20:Mercancias | //cartaporte30:Mercancias') as $Mercancias) {
                ...
                foreach ($xml2->xpath('//cartaporte20:Mercancias//cartaporte20:IdentificacionVehicular | //cartaporte30:Mercancias//cartaporte30:IdentificacionVehicular') as $Vehicular) {
                ...
                $tiposFigura = $xml2->xpath('//cfdi:Comprobante//cfdi:Complemento//cartaporte20:CartaPorte//cartaporte20:FiguraTransporte//cartaporte20:TiposFigura | //cfdi:Comprobante//cfdi:Complemento//cartaporte30:CartaPorte//cartaporte30:FiguraTransporte//cartaporte30:TiposFigura')[0];
                ...
                //if($cont6==0){
                $Placa=$xml2->xpath('//cfdi:Comprobante//cfdi:Complemento//cartaporte20:CartaPorte//cartaporte20:Mercancias//cartaporte20:Remolques//cartaporte20:Remolque//@Placa | //cfdi:Comprobante//cfdi:Complemento//cartaporte30:CartaPorte//cartaporte30:Mercancias//cartaporte30:Remolques//cartaporte30:Remolque//@Placa');
                ...
                //UnidadPeso
                foreach ($xml2->xpath('//cartaporte20:Mercancias//cartaporte20:Mercancia | //cartaporte30:Mercancias//cartaporte30:Mercancia') as $Merc) {
                ...
                RemitenteNumRegIdTrib, DestinatarioNumRegIdTrib,RegimenAduanero_REN,RegimenAduanero_RID,IdCCP, Ticket) values
                 ('$newid','$xfolio','$folio','$time','1','Clientes','".$_POST['cliente']."','Oficinas','".$_POST['oficina']."','$fchaVigenciaCSD','".$fecha."','TablaGeneral','".$formaPago."','TablaGeneral','".$metodoPago."',
                ...
                'Unidades','".$Rem1."','Unidades','".$Rem2."','$folio','$retOficina','$ivaOficina','".$fecha."','$numRegIdTribRemitente', '$numRegIdTribDestinatario','c_RegimenAduanero','$regimenAduanero','$idCCPT', '$noIdentificacion');";
				 //$newquery=$queryP;
                $queryP=str_replace("''","NULL",$queryP);
                $queryP=str_replace("á","a",$queryP);
                $queryP=str_replace("é","e",$queryP);
