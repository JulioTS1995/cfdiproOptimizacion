...
$cont1=0;
$cont2=0;//contadores para recorrer los nodos de forma correcta
$cont3=0;
$cont4=0;
$cont5=0;
$cont6=0;
  ...
  if($filename[1] == ('xml')||('XML')){
    ...
    foreach ($xml2->xpath('//cfdi:Receptor') as $Receptor) {
        ...
        foreach ($xml2->xpath('//cfdi:Conceptos//cfdi:Concepto') as $Concepto) {
            ...
            $TranspInternac=$xml2->xpath('//cfdi:Complemento//cartaporte20:CartaPorte//@TranspInternac');
            $EntradaSalidaMerc=$xml2->xpath('//cfdi:Complemento//cartaporte20:CartaPorte//@EntradaSalidaMerc');
            ...
            foreach ($xml2->xpath('//cartaporte20:Ubicacion') as $Ubicacion) {
                if($cont4==0){
            ...
            foreach ($xml2->xpath('//cartaporte20:Ubicacion//cartaporte20:Domicilio') as $Domicilio) {
                if ($cont5==0){
            ...
            foreach ($xml2->xpath('//cartaporte20:Mercancias') as $Mercancias) {
                ...
                foreach ($xml2->xpath('//cartaporte20:Mercancias//cartaporte20:IdentificacionVehicular') as $Vehicular) {
                ...
                $Operador=$xml2->xpath('//cfdi:Comprobante//cfdi:Complemento//cartaporte20:CartaPorte//cartaporte20:FiguraTransporte//cartaporte20:TiposFigura//@RFCFigura');
                ...
                //UnidadPeso
                foreach ($xml2->xpath('//cartaporte20:Mercancias//cartaporte20:Mercancia') as $Merc) {
    ...
    //echo $key.": ".$value."</br>";
                ...
                RemitenteReferencia,DestinatarioReferencia,CitaCarga,DestinatarioCitaCarga,Unidad_REN,Unidad_RID,ConfigAutotranporte_REN,ConfigAutotranporte_RID,cfdiselloSAT,Operador_REN,Operador_RID,TipoViaje,Remolque_REN,Remolque_RID,Remolque2_REN,Remolque2_RID,Comentarios,xRetencion,xIVA,FECreado) values
                ...
                'Unidades','".$Rem1."','Unidades','".$Rem2."','$folio','$retOficina','$ivaOficina','".$fecha."');";
				 //$newquery=$queryP;
                $queryP=str_replace("''","NULL",$queryP);
                $queryP=str_replace("á","a",$queryP);
                $queryP=str_replace("é","e",$queryP);
