...
foreach ($_FILES['file']['tmp_name'] as $key => $value) {
  ...
  if($filename[1] == ('xml')||('XML')){
    ...
    //echo $key.": ".$value."</br>";
                ...
                RemitenteReferencia,DestinatarioReferencia,CitaCarga,DestinatarioCitaCarga,Unidad_REN,Unidad_RID,ConfigAutotranporte_REN,ConfigAutotranporte_RID,cfdiselloSAT,Operador_REN,Operador_RID,TipoViaje,Remolque_REN,Remolque_RID,Remolque2_REN,Remolque2_RID,Comentarios,xRetencion,xIVA,FECreado,Ticket) values
                ...
                'Unidades','".$Rem1."','Unidades','".$Rem2."','$folio','$retOficina','$ivaOficina','".$fecha."','".$noIdentificacion."');";
				 //$newquery=$queryP;
                $queryP=str_replace("''","NULL",$queryP);
                $queryP=str_replace("á","a",$queryP);
                $queryP=str_replace("é","e",$queryP);
