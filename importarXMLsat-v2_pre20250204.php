    ...
    foreach ($xml2->xpath('//cfdi:Receptor') as $Receptor) {
        ...
        $new2id =  obtenerSiguienteID($cnx_cfdi2);
            ...
            foreach ($xml2->xpath('//cartaporte20:Mercancias | //cartaporte30:Mercancias') as $Mercancias) {
                ...
                RemitenteNumRegIdTrib, DestinatarioNumRegIdTrib,RegimenAduanero_REN,RegimenAduanero_RID,IdCCP) values
                ...
                'Unidades','".$Rem1."','Unidades','".$Rem2."','$folio','$retOficina','$ivaOficina','".$fecha."','$numRegIdTribRemitente', '$numRegIdTribDestinatario','c_RegimenAduanero','$regimenAduanero','$idCCPT');";
				 //$newquery=$queryP;
                $queryP=str_replace("''","NULL",$queryP);
                $queryP=str_replace("á","a",$queryP);
                $queryP=str_replace("é","e",$queryP);
