...
//die('sientra');
            ...
            if ($key == 'SubTipoRem'){
                ...
                $queryP = "INSERT INTO ".$prefijobd."FacturasSub(ID,Mt3,Modificado,PesoVolumen,PesoEstimado,Peso,BASTIMESTAMP,BASVERSION,Documentador,FolioSub_REN, FolioSub_RID, Cantidad,
                ...
                ('$new2id',0,'$time',0,0,'".$PesoEnKg."','$time',0,'Tractosoft','Factura', '$idRem', '$CantidadItem', '$Descripcion','0', 'c_MaterialPeligroso', '$CveMaterialPeligroso',
