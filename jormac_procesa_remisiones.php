...
if($v_total0 == 0){
	echo "<script>
			...
			window.location= 'jormac_update_remisiones.php'
		  </script>";
} else{
	...
	//		window.location= 'leds_update_remisiones.php'
	//	  </script>";
	//} else {
		...
		if($v_total == 0){
			...
			if($v_yFlete > 0){
				...
				$sql = "INSERT INTO " . $prefijodb . "remisionespartidas (ID, BASTIMESTAMP, ConceptoPartida, FolioConceptos_REN, FolioConceptos_RID, DescuentoImporte, IVA, Detalle, Subtotal, Tipo, RetencionImporte, FolioSub_REN, FolioSub_RID, FolioSub_RMA, Descuento, prodserv33, claveunidad33, Cantidad, Importe, IVAImporte, PrecioUnitario, Retencion, Excento, prodserv33dsc) VALUES (". $newid .", '".$fecha."', 'FLETE', 'Conceptos', 2052385, 0, 16, '', ".$subtotal.", 'Flete', ".$retencion_importe.", 'Remisiones', ".$v_id_factura.", 'FolioSubPartidas', 0, '78101800', 'E48', 1, ".$importe.", ".$iva_importe.", ".$v_yFlete.", 4, 0, 'Transporte de Carga por Carretera')";
			...
			if($v_ySeguro > 0){
				...
				$sql = "INSERT INTO " . $prefijodb . "remisionespartidas (ID, BASTIMESTAMP, ConceptoPartida, FolioConceptos_REN, FolioConceptos_RID, DescuentoImporte, IVA, Detalle, Subtotal, Tipo, RetencionImporte, FolioSub_REN, FolioSub_RID, FolioSub_RMA, Descuento, prodserv33, claveunidad33, Cantidad, Importe, IVAImporte, PrecioUnitario, Retencion, Excento, prodserv33dsc) VALUES (". $newid .", '".$fecha."', 'SEGURO', 'Conceptos', 2052386, 0, 16, '', ".$subtotal.", 'Seguro', ".$retencion_importe.", 'Remisiones', ".$v_id_factura.", 'FolioSubPartidas', 0, '1010101', 'E48', 1, ".$importe.", ".$iva_importe.", ".$v_ySeguro.", 0, 0, 'POR DEFINIR')";
			...
			if($v_yCarga > 0){
				...
				$sql = "INSERT INTO " . $prefijodb . "remisionespartidas (ID, BASTIMESTAMP, ConceptoPartida, FolioConceptos_REN, FolioConceptos_RID, DescuentoImporte, IVA, Detalle, Subtotal, Tipo, RetencionImporte, FolioSub_REN, FolioSub_RID, FolioSub_RMA, Descuento, prodserv33, claveunidad33, Cantidad, Importe, IVAImporte, PrecioUnitario, Retencion, Excento, prodserv33dsc) VALUES (". $newid .", '".$fecha."', 'CARGA', 'Conceptos', 2052387, 0, 16, '', ".$subtotal.", 'Carga', ".$retencion_importe.", 'Remisiones', ".$v_id_factura.", 'FolioSubPartidas', 0, '78121601', 'E48', 1, ".$importe.", ".$iva_importe.", ".$v_yCarga.", 0, 0, 'Carga y Descarga de Mercancias')";
			...
			if($v_yDescarga > 0){
				...
				$sql = "INSERT INTO " . $prefijodb . "remisionespartidas (ID, BASTIMESTAMP, ConceptoPartida, FolioConceptos_REN, FolioConceptos_RID, DescuentoImporte, IVA, Detalle, Subtotal, Tipo, RetencionImporte, FolioSub_REN, FolioSub_RID, FolioSub_RMA, Descuento, prodserv33, claveunidad33, Cantidad, Importe, IVAImporte, PrecioUnitario, Retencion, Excento, prodserv33dsc) VALUES (". $newid .", '".$fecha."', 'DESCARGA', 'Conceptos', 2052388, 0, 16, '', ".$subtotal.", 'Descarga', ".$retencion_importe.", 'Remisiones', ".$v_id_factura.", 'FolioSubPartidas', 0, '78121601', 'E48', 1, ".$importe.", ".$iva_importe.", ".$v_yDescarga.", 0, 0, 'Carga y descarga de Mercancias')";
			...
			if($v_yDemoras > 0){
				...
				$sql = "INSERT INTO " . $prefijodb . "remisionespartidas (ID, BASTIMESTAMP, ConceptoPartida, FolioConceptos_REN, FolioConceptos_RID, DescuentoImporte, IVA, Detalle, Subtotal, Tipo, RetencionImporte, FolioSub_REN, FolioSub_RID, FolioSub_RMA, Descuento, prodserv33, claveunidad33, Cantidad, Importe, IVAImporte, PrecioUnitario, Retencion, Excento, prodserv33dsc) VALUES (". $newid .", '".$fecha."', 'DEMORAS', 'Conceptos', 2052391, 0, 16, '', ".$subtotal.", 'Demoras', ".$retencion_importe.", 'Remisiones', ".$v_id_factura.", 'FolioSubPartidas', 0, '1010101', 'E48', 1, ".$importe.", ".$iva_importe.", ".$v_yDemoras.", 0, 0, 'POR DEFINIR')";
			...
			if($v_yAutopistas > 0){
				...
				$sql = "INSERT INTO " . $prefijodb . "remisionespartidas (ID, BASTIMESTAMP, ConceptoPartida, FolioConceptos_REN, FolioConceptos_RID, DescuentoImporte, IVA, Detalle, Subtotal, Tipo, RetencionImporte, FolioSub_REN, FolioSub_RID, FolioSub_RMA, Descuento, prodserv33, claveunidad33, Cantidad, Importe, IVAImporte, PrecioUnitario, Retencion, Excento, prodserv33dsc) VALUES (". $newid .", '".$fecha."', 'AUTOPISTAS', 'Conceptos', 2052392, 0, 16, '', ".$subtotal.", 'Autopistas', ".$retencion_importe.", 'Remisiones', ".$v_id_factura.", 'FolioSubPartidas', 0, '95111600', 'E48', 1, ".$importe.", ".$iva_importe.", ".$v_yAutopistas.", 0, 0, 'Vias de Trafico Abierta')";
