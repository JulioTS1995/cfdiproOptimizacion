...
$nombrebat = "mantenimientos_pdf1.bat";
...
//Linea modificada:
//echo "C:\\xampp\\htdocs\\cfdipro\\".$nombrebat." ".$_REQUEST["id"]." ".$nombrereporte." ".$prefijobd;
...
$rutadescarga = $RutaServer."mantenimiento_".$_REQUEST["id"].".pdf";
