...
<head>
    ...
    <title>Notificacion Evidencia Rechazada ' . $folioOC .'</title>
</head>
<body>
    <p>Proveedor,</p>
    <p>Su documentación de la <strong>OC '.$folioOC.'</strong> ha sido <strong>rechazada</strong> por lo cual no puede proseguir al pago de la factura.  </p>
    <p>Favor de cargar la evidencia con los requisitos de la misma.</p>
    <br><br>
...
if (empty($correosValidos)) {
    ...
    $mail->Subject = 'Notificacion Evidencia Rechazada ' . $folioOC;
    $mail->Body = $mensaje;
