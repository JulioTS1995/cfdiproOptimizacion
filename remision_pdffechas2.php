...
if ($debug == 1) {
	...
	$_REQUEST['prefijo'] = "Mar";
	$_REQUEST['numreporte'] = 12;
}

//======================================================================
// Se define el nombre del archivo bat.
$nombrebat = "remision_pdffechas.bat";
...
//Linea original:
//$linea = exec("C:\\xampp\\htdocs\\cfdipro\\remision_pdf1.bat ".$_REQUEST["remisionid"]);

//Linea modificada:
$linea = exec("C:\\xampp\\htdocs\\cfdipro\\".$nombrebat." ".$_REQUEST["id"]." ".$nombrereporte." ".$prefijobd);
$RutaServer = "ftp://108.163.180.18:21000/xml_Mar/";
$rutadescarga = $RutaServer. "ReporteRemisionesFechas.pdf";
echo "<a href='" . $rutadescarga . "'>Reporte Remisiones Fechas</a>";
