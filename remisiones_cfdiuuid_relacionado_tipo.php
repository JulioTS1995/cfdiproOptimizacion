			...
			<form action="remisiones_cfdiuuid_relacionado_tipo_2.php" name="form1" method="post" enctype="application/x-www-form-urlencoded" id="form1">
				<div class="form-group">
					...
					<select class="form-control" id="txt_tipo_relacion" name="txt_tipo_relacion">
						...
						<option value="055">05 - Traslados de Mercancias Facturados Previamente - Facturas</option>
					...
					<br>
					<label><strong>Folio a Relacionar:</strong></label>
					<input id="xfolio_buscar" type="text" width="100%" name="xfolio_buscar" size="10" class="form-control" />
...
//http://localhost/cfdipro/remisiones_cfdiuuid_relacionado_tipo.php?prefijodb=UNIDOS_&id=14924326&xfolio=CT1186
//UD1005
//UD100
//Ejemplo
//CT213
