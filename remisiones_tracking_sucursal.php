...
<div id="container">
  <div id="header">
    <h1>Ultimo Tracking por Remision
      <!-- end #header -->
    </h1>
  </div>
  <div id="sidebar1">
  ...
  <?php
	...
	$resSQL="SELECT R.ID, R.XFolio, R.Unidad_RID, R.Creado, U.Unidad  FROM ".$prefijobd."remisiones R, ".$prefijobd."unidades U WHERE Date(Creado) Between '".$_POST["fechai"]."' And '".$_POST["fechaf"]."' AND R.Unidad_RID = U.ID AND U.Sucursal_RID = ".$sucursal." ORDER BY U.Unidad";
