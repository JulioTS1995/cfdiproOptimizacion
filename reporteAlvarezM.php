...
<title>INFORMACION ADICIONAL DEVOLUCIONES</title>
<style type="text/css">
.style1 {
...
.style3 {
	...
	<body>  
	  <form action="reporteAlvarez.php" method="post">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<label>Facturas:
					<select class="form-control inputdefault" name="fact" id="fact">
					<option value='0'>Todas</option>
						
					<option value='1'>Pagadas</option>
					<!--option value='2'>Notas de Credito</option-->
