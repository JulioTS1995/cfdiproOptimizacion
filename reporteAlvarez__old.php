...
?>
	<meta http-equiv="Content-Type" content="text/html; charset= UTF-8">
              ...
              <th class="input">TOTAL PAGADO</th>
					...
					$resSQL01 = "SELECT * FROM ".$prefijobd."Factura WHERE cCanceladoT IS NULL AND Date(Creado) Between '".$_POST["fechai"]." 00:00:00' And '".$_POST["fechaf"]." 23:59:59' ".$cntQuery." ".$cntQuery2." ORDER BY Creado;";
