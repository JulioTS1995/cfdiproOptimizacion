	...
	<div class="container">
		<div class="row">
			...
			<br>
				...
				<br>
				<center>
					<form method="post" action="reporteCombustibleSucursal.php" enctype="multipart/form-data">
				...
				mysqli_select_db($cnx_cfdi2,$database_cfdi);
						...
						$resSQL = "SELECT ID,Operador FROM ".$_GET["prefijodb"]."operadores WHERE Estatus = 'Activo' AND Sucursal_RID = ".$sucursal." ORDER BY Operador";
				...
				mysqli_select_db($cnx_cfdi2,$database_cfdi);
						...
						$resSQL = "SELECT ID,Unidad FROM ".$_GET["prefijodb"]."unidades WHERE Activa = 'Activa' AND Sucursal_RID = ".$sucursal." ORDER BY Unidad";
					$runSQL = mysqli_query($cnx_cfdi2,$resSQL);
					if (!$runSQL) {//debug
						$mensaje  = 'Consulta no válida: ' . mysqli_error($cnx_cfdi2) . "\n";
						$mensaje .= 'Consulta completa: ' . $resSQL;
