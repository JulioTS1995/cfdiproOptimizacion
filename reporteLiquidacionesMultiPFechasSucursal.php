  ...
  <div class="container">
	  <div class="row">
		  ...
		  <br>
			  ...
			  <h2 class="font-weight-bold" style="text-align: center;color:#0059b3; line-height: 100px;">Reporte Liquidaciones</h2>
			  </div>
			  <br>
			  <center>
			  <form method="post" action="reporteLiquidacionesMultiPSucursal.php" enctype="multipart/form-data">
