...
<head>
  <meta charset="UTF-8">
  <title>Reporte ordenes de compra · Filtros</title>
...
<body>
  <div class="container">
    ...
    <div class="panel">
      <form method="post" action="reporteOrdenCompra.php" autocomplete="off">
        <div class="form-group field" style="width:95%;">
          <label for="proveedor">Proveedor</label>
          <input type="text" id="buscar_1" class="form_control" placeholdel="Escribe la Razon Social del Proveedor">
