  ...
  <head>
	...
	<body>
		<div class="col-md-8 col-md-offset-2">
			...
			<center>
			  <form method="post" action="reporte_abonos.php" enctype="multipart/form-data" target="_blank">	
				<div class="row">
					<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" name="oficina" id="oficina">
								 ...
								 <?php 
									//Buscar Oficinas
									$sql1 = "SELECT * FROM ".$prefijobd."oficinas where Serie in ('AP','NC') ORDER BY Serie";
									$res1 = mysql_query($sql1, $cnx_cfdi);
									while($row1 = mysql_fetch_array($res1)){
										$id_oficina = $row1['ID'];
										$nom_oficina = $row1['Serie'];
								?>
									<option value="<?php echo $id_oficina; ?>"><?php echo $nom_oficina; ?></option>
								<?php
									}
								?>
								</select>
...
<!-- http://174.142.68.199/cfdipro/ventas_por_cliente_fechas.php?prefijodb=prbsls_ -->