      ...
      <h1 style="font-size: 20px;">Cuentas por Cobrar</h1>';
            ...
            <div id="project">
              ...
              <div>
                ...
                //Agrupar por cliente
                $resSQL01 = "SELECT DISTINCT(CargoAFactura_RID) FROM ".$prefijobd."factura WHERE CobranzaSaldo > 0 AND cCanceladoT IS NULL ORDER BY CargoAFactura_RID";
				...
				';
					...
					$resSQL03 = "SELECT * FROM ".$prefijobd."factura WHERE CobranzaSaldo > 0 AND cCanceladoT IS NULL AND CargoAFactura_RID = ".$id_cliente." ORDER BY Vence";
                ...
                $html.='
					...
					$resSQL04 = "SELECT SUM(CobranzaSaldo) AS Tsaldo FROM ".$prefijobd."factura WHERE CobranzaSaldo > 0 AND cCanceladoT IS NULL AND CargoAFactura_RID = ".$id_cliente;
					...
					$resSQL05 = "SELECT SUM(CobranzaAbonado) AS Tabonado FROM ".$prefijobd."factura WHERE CobranzaSaldo > 0 AND cCanceladoT IS NULL AND CargoAFactura_RID = ".$id_cliente;
