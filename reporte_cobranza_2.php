...
.style3 {
	...
	<body>  
	  <form action="reporte_cobranza_pdf_excel.php" method="post" target="_blank">
	<div class="col-md-8 col-md-offset-2">
		<div class="row">
			<div class="col-md-12">
				<h2><b>Reporte Cuentas por Cobrar</b></h2>
			</div>
		</div>
		<br>
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					<label>Serie:</label>
						<input type="text" name="serie" id="serie" value="" class="form-control">
						<p class="help-block text-danger"></p>
				</div>
			</div>
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="form-group" align="center">
					<label></label>
					<p><input type="submit" value="PDF" name="button" id="button" class="btn btn-danger btn-lg "> <input type="submit" value="Excel" name="button" id="button" class="btn btn-success btn-lg "></p>
				</div>
			</div>
...
<!-- http://72.55.137.183/cfdipro/reporte_cobranza.php?prefijodb=prbolpega_ -->
