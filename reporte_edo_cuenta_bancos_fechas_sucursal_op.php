...
.style3 {
	...
	<body>  
	  <form action="reporte_edo_cuenta_bancos_sucursal_op.php" method="post">
	<div class="col-md-8 col-md-offset-2">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="form-group">
					<label>Banco:</label>
						<select class="form-control" name="banco" id="banco" required="required>
							<option value="0">- Seleccione -</option>
								<?php 
									//Buscar Banco 
									$sql2 = "SELECT * FROM ".$prefijodb."bancos WHERE Sucursal_RID = ".$sucursal." ORDER BY Banco";
									$res2 = mysql_query($sql2, $cnx_cfdi);
									while($row2 = mysql_fetch_array($res2)){
										$id_banco = $row2['ID'];
										$nom_banco = $row2['Banco'];
								?>
									<option value="<?php echo $id_banco; ?>"><?php echo $nom_banco; ?></option>
								<?php
									}
								?>
						</select>
...
<!-- http://174.142.207.143/cfdipro/reporte_edo_cuenta_bancos_fechas.php?prefijodb=prbalpenasa_ -->