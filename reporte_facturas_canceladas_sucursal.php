            ...
            <div id="project">
              ...
              <div>
				...
				while($rowSQL00 = mysql_fetch_array($runSQL00)){
					...
					$resSQL08 = "SELECT * FROM ".$prefijobd."Clientes WHERE ID = ".$id_cliente." AND Sucursal_RID = ".$sucursal."";
					...
					where Date(f.Creado) Between '".$fechai." 00:00:00' AND '".$fechaf." 23:59:59' ".$sql_moneda."AND CargoAFactura_RID = ".$id_cliente." and f.cCanceladoT AND c.Sucursal_RID = ".$sucursal." IS NOT NULL";
...
?>
	<meta http-equiv="Content-Type" content="text/html; charset= UTF-8">
				...
				<table class="table table-hover table-responsive table-condensed" border="1" id="table">
					...
					$resSQL01 = "select f.cCanceladoT,f.XFolio,f.Moneda,f.zSubtotal,f.zImpuesto,f.zRetenido,f.zTotal,c.RazonSocial,f.CargoAFactura_RID FROM ".$prefijobd."factura as f 
					inner join ".$prefijobd."clientes as c on f.CargoAFactura_RID=c.ID
					where Date(f.Creado) Between '".$fechai." 00:00:00' AND '".$fechaf." 23:59:59' ".$sql_moneda."AND CargoAFactura_RID = ".$id_cliente." and f.cCanceladoT IS NOT NULL AND FECreado IS NOT NULL AND c.Sucursal_RID = ".$sucursal." ORDER BY f.XFolio";
					$runSQL01 = mysql_query($resSQL01, $cnx_cfdi);
					while($rowSQL01 = mysql_fetch_array($runSQL01)){
						$Creado_t = $rowSQL01['cCanceladoT'];
						$Creado = date("d-m-Y", strtotime($Creado_t));
              ...
              <div>
                <table>
                  ...
                  <tbody>';
					...
					inner join ".$prefijobd."clientes as c on f.CargoAFactura_RID=c.ID
					where Date(f.Creado) Between '".$fechai." 00:00:00' AND '".$fechaf." 23:59:59' ".$sql_moneda.$sql_cliente." and f.cCanceladoT IS NOT NULL AND c.Sucursal_RID = ".$sucursal."";
...
?>
	<meta http-equiv="Content-Type" content="text/html; charset= UTF-8">
				...
				<table class="table table-hover table-responsive table-condensed" border="1" id="table">
					...
					inner join ".$prefijobd."clientes as c on f.CargoAFactura_RID=c.ID
					where Date(f.Creado) Between '".$fechai." 00:00:00' AND '".$fechaf." 23:59:59' ".$sql_moneda." AND CargoAFactura_RID = ".$id_cliented." and f.cCanceladoT IS NOT NULL AND f.FECreado IS NOT NULL AND c.Sucursal_RID = ".$sucursal." ORDER BY f.XFolio";
