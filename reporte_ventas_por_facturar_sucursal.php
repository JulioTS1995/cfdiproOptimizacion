              ...
              <div>
                <table>
                  ...
                  <tbody>';
					...
					where Date(f.Creado) Between '".$fechai." 00:00:00' AND '".$fechaf." 23:59:59' ".$sql_moneda.$sql_cliente." and 
					c.Sucursal_RID = ".$sucursal." AND f.FECreado IS NOT NULL";
...
<?php
	...
	left join ".$prefijobd."facturasdetalle d on d.FolioSubDetalle_RID=f.ID
	left join ".$prefijobd."remisiones r on d.Remision_RID= r.ID
	where Date(f.Creado) Between '".$fechai." 00:00:00' AND '".$fechaf." 23:59:59' ".$sql_moneda.$sql_cliente." AND f.FECreado IS NOT NULL AND c.Sucursal_RID = ".$sucursal." ORDER BY f.XFolio";
              ...
              <div>
                <table>
                  ...
                  <tbody>';
					...
					//Buscar facturas del cliente	
					$resSQL01 = "select f.Creado,f.XFolio,f.Ticket,f.zSubtotal,f.zImpuesto,f.zRetenido,f.zTotal,c.RazonSocial,f.TipoCambio,r.XFolio as CartaPorte, r.EstatusCobranza as EstatusCobranza FROM ".$prefijobd."factura as f 
					inner join ".$prefijobd."clientes as c on f.CargoAFactura_RID=c.ID
					left join ".$prefijobd."facturasdetalle d on d.FolioSubDetalle_RID=f.ID
					left join ".$prefijobd."remisiones r on d.Remision_RID= r.ID
					where Date(f.Creado) Between '".$fechai." 00:00:00' AND '".$fechaf." 23:59:59' ".$sql_moneda.$sql_cliente." and f.FECreado IS NOT NULL AND c.Sucursal_RID = ".$sucursal."";
...
?>
		...
		<tr>
			...
			<td align="right" ><?php echo $Neto; ?></td>
			<td align="right" ><?php echo $FechaCancelado; ?></td>
			<td align="right" ><?php echo $EstatusCobranza; ?></td>
		</tr>
