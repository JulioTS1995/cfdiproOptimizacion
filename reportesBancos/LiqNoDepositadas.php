...
<?php
	...
	Date(l.Fecha)Between '".$_POST["fechai"]." 00:00:00' AND '".$_POST["fechaf"]." 23:59:59' ORDER BY l.Fecha;";
	...
	<div class="row">
		<div class="col-md-12" style="text-align:left">
			<a href="LiqNoDepositadasExcel.php?fechai=<?php echo $fecha_inicio; ?>&fechaf=<?php echo $fecha_fin; ?>&prefijodb=<?php echo $prefijobd; ?>"><button type="button" class="btn btn-success">Exporta a Excel</button></a>
		</div>
	</div>
	<br>
	<br>
