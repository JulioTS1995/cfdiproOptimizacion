...
<?php
	...
	<div class="row">
		<div class="col-md-12" style="text-align:left">
			<a href="abonosNoDepositadosExcelSucursal.php?fechai=<?php echo $fecha_inicio; ?>&fechaf=<?php echo $fecha_fin; ?>&prefijodb=<?php echo $prefijobd; ?>>&sucursal=<?php echo $sucursal; ?>"><button type="button" class="btn btn-success">Exporta a Excel</button></a>
		</div>
	</div>
	<br>
	<br>
