...
<?php
	...
	'' AS Referencia, g.Importe AS Cargo, 0 AS Abono, 'Deposito Operador' AS TipoDoc, (SELECT Cuenta FROM ".$prefijobd."Bancos WHERE ID = g.TransferenciaBanco_RID) AS Cuenta
	 FROM ".$prefijobd."GastosViajes AS g WHERE g.Depositado='1' AND OficinaGastos_RID IN (SELECT ID FROM ".$prefijobd."Oficinas WHERE Sucursal_RID = ".$sucursal." ) AND 
	...
	'' AS Referencia, p.Total AS Cargo, 0 AS Abono, 'Pago' AS TipoDoc, (SELECT Cuenta FROM ".$prefijobd."Bancos WHERE ID = p.Banco_RID) AS Cuenta
	 FROM ".$prefijobd."Pagos AS p WHERE p.Depositado='1' AND OficinaPagos_RID IN (SELECT ID FROM ".$prefijobd."Oficinas WHERE Sucursal_RID = ".$sucursal." ) AND 
	...
	'' AS Referencia, 0 AS Cargo, a.TotalImporte AS Abono, 'Abono' AS TipoDoc, (SELECT Cuenta FROM ".$prefijobd."Bancos WHERE ID = a.CuentaBancaria_RID) AS Cuenta
	 FROM ".$prefijobd."Abonos AS a WHERE a.Depositado='1' AND Oficina_RID IN (SELECT ID FROM ".$prefijobd."Oficinas WHERE Sucursal_RID = ".$sucursal." ) AND 
	...
	'' AS Referencia, l.yComisionOperador AS Cargo, 0 AS Abono, 'Liquidacion' AS TipoDoc, (SELECT Cuenta FROM ".$prefijobd."Bancos WHERE ID = l.CuentaBancaria_RID) AS Cuenta
	 FROM ".$prefijobd."Liquidaciones AS l WHERE l.Depositado='1' AND OficinaLiquidacion_RID IN (SELECT ID FROM ".$prefijobd."Oficinas WHERE Sucursal_RID = ".$sucursal." ) AND 
	Date(l.Fecha)Between '".$_GET["fechai"]." 00:00:00' AND '".$_GET["fechaf"]." 23:59:59' ".$liquiBancoQuery."
	UNION
	...
	'' AS Referencia, 0 AS Cargo, d.Monto AS Abono, 'Deposito' AS TipoDoc, (SELECT Cuenta FROM ".$prefijobd."Bancos WHERE ID = d.Banco_RID) AS Cuenta
	 FROM ".$prefijobd."Depositos AS d WHERE d.Depositado='1' AND Banco_RID IN (SELECT ID FROM ".$prefijobd."Bancos WHERE Sucursal_RID = ".$sucursal." ) AND 
	Date(d.FechaMovimiento)Between '".$_GET["fechai"]." 00:00:00' AND '".$_GET["fechaf"]." 23:59:59' ".$depositosBancoQuery."
	UNION
	...
	'' AS Referencia, r.Monto AS Cargo, 0 AS Abono, 'Retiro' AS TipoDoc, (SELECT Cuenta FROM ".$prefijobd."Bancos WHERE ID = r.Banco_RID) AS Cuenta
	 FROM ".$prefijobd."Retiros AS r WHERE r.Depositado='1' AND Banco_RID IN (SELECT ID FROM ".$prefijobd."Bancos WHERE Sucursal_RID = ".$sucursal." ) AND 
	Date(r.FechaMovimiento)Between '".$_GET["fechai"]." 00:00:00' AND '".$_GET["fechaf"]." 23:59:59' ".$retirosBancoQuery.") AS Resultados
