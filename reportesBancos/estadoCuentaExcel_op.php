...
<?php
	...
	'' AS Referencia, p.Importe AS Cargo, 0 AS Abono, 'Retiro' AS TipoDoc, (SELECT Cuenta FROM ".$prefijobd."Bancos WHERE ID = p.Banco_RID) AS Cuenta
	...
	//echo $resSQL;
	//echo "<br>";
	//echo "Reporte: estadoCuentaExcel.php";
