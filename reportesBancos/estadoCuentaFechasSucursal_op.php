		...
		<div class="row">
			...
			<br>
				<div id="encabezadoform" style="text-align:center">
				  <h2 class="font-weight-bold" style="text-align: center;color:#0059b3; line-height: 100px;">Estado de Cuenta</h2>
				</div>
				<br>
				<center>
					<form method="post" action="estadoCuenta_op.php" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<label>Cuenta:</label>
							<select class="form-control inputdefault" name="banco" id="banco" required aria-required="true">
								<option value='0'>Selecciona Cuenta</option>
							<?php
							require_once('../cnx_cfdi2.php');
							mysqli_select_db($cnx_cfdi2,$database_cfdi);    
							$resSQL = "SELECT ID, Cuenta, Banco FROM ".$prefijobd."Bancos WHERE Sucursal_RID = ".$sucursal." ORDER BY Banco";
							$runSQL = mysqli_query($cnx_cfdi2,$resSQL);  
							while ($rowSQL = mysqli_fetch_assoc($runSQL))
							{
								?>
								<option value='<?php echo $rowSQL['ID']; ?>'><?php echo "".$rowSQL['Cuenta']." / ".$rowSQL['Banco']; ?></option>
							<?php
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<label>Documento:
							<select class="form-control inputdefault" name="doc" id="doc">
							<option value='0'>Selecciona el tipo de Documento</option>
								
							<option value='Deposito Operador'>Deposito Operador</option>
