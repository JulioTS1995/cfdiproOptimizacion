...
<?php
	...
	'' AS Referencia, 0 AS Cargo, p.Total AS Abono, 'Pago' AS TipoDoc, (SELECT Cuenta FROM ".$prefijobd."Bancos WHERE ID = p.Banco_RID) AS Cuenta
	...
	Date(l.Fecha)Between '".$_POST["fechai"]." 00:00:00' AND '".$_POST["fechaf"]." 23:59:59' ".$liquiBancoQuery.") AS Resultados
