...
<?php
	...
	Date(r.FechaMovimiento)Between '".$_POST["fechai"]." 00:00:00' AND '".$_POST["fechaf"]." 23:59:59' ".$retirosBancoQuery."
	UNION
	SELECT p.Folio, p.Fecha, p.Concepto AS Detalle, 
	'' AS Referencia, p.Importe AS Cargo, 0 AS Abono, 'Prestamo' AS TipoDoc, (SELECT Cuenta FROM ".$prefijobd."Bancos WHERE ID = p.Banco_RID) AS Cuenta
	 FROM ".$prefijobd."Prestamos AS p WHERE p.Depositado='1' AND 
	Date(p.Fecha) Between '".$_POST["fechai"]." 00:00:00' AND '".$_POST["fechaf"]." 23:59:59' ".$prestamosBancoQuery.") AS Resultados
	...
	<div class="row">
		<div class="col-md-12" style="text-align:left">
			<a href="estadoCuentaExcel_op.php?fechai=<?php echo $fecha_inicio; ?>&fechaf=<?php echo $fecha_fin; ?>&prefijodb=<?php echo $prefijobd; ?>&doc=<?php echo $doc; ?>&banco=<?php echo $banco; ?>"><button type="button" class="btn btn-success">Exporta a Excel</button></a>
		</div>
	</div>
	<br>
	<br>
