...
$nombre="Reporte_Pagos_No_Depositados_".$fecha_inicio_f."-"."$fecha_fin_f"."__".date("d-m-Y")."_".date("h:i").".xls";//
...
<table border="1" class="tablas_form" style="padding:0px; margin:0 0 15 0; font-size:12px;" cellspacing="0" cellpadding="2" id="table_busqueda_rep">
	<thead>
	<tr>
		<th align="center" colspan="7" style="font-size: 18px;">Pagos No Depositados. Periodo: <?php echo $fecha_inicio_f." a ".$fecha_fin_f; ?></th>
	</tr>
	<tr>
...
$resSQL="SELECT p.ID, p.XFolio, p.Fecha, (SELECT RazonSocial FROM ".$prefijobd."Proveedores WHERE ID = p.Proveedor_RID) AS Proveedor, 
	...
	Date(p.Fecha)Between '".$_GET["fechai"]." 00:00:00' AND '".$_GET["fechaf"]." 23:59:59' ORDER BY p.Fecha;";
