		...
		<div class="row">
			...
			<br>
				<div id="encabezadoform" style="text-align:center">
				  <h2 class="font-weight-bold" style="text-align: center;color:#0059b3; line-height: 100px;">Pagos No Depositados</h2>
				</div>
				<br>
				<center>
					<form method="post" action="pagosNoDepositadosSucursal.php" enctype="multipart/form-data">
