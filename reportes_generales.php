...
<table border="1" class="tablas_form" style="padding:0px; margin:0 0 15 0; font-size:12px;" cellspacing="0" cellpadding="2" id="table_busqueda_rep">
	<thead>
		<tr>
			<th align="center" colspan="6" style="font-size: 20px;">Detalle de Facturas. Periodo: <?php echo $fechaInicio_f."-".$fechaFin_f; ?></th>
		</tr>
		<tr>
			...
			<th align="center" style="font-size: 16px;">METODOO PAGO</th>
...
<?php
	...
	if ($resSQL1->execute()) {
		// Procede a bind_result y fetch
	} else {
		echo "Error al ejecutar la consulta: " . $resSQL1->error;
	}
	...
	while ($resSQL1->fetch()) {
		...
		if ($existe>0){
			// Aquí en tu código original no hacías nada, lo dejo igual
		}
		...
		//$estatus = !empty((array)$obj->{'EstatusCancelacion'}) ? $obj->{'EstatusCancelacion'} : 'NA'; 
?>
		<tr>
...
<table border="1" class="tablas_form" style="padding:0px; margin:0 0 15 0; font-size:12px;" cellspacing="0" cellpadding="2" id="table_busqueda_rep">
	<thead>
		<tr>
			<th align="center" colspan="6" style="font-size: 20px;">Detalle de REPS. Periodo: <?php echo $fechaInicio_f."-".$fechaFin_f; ?></th>
        </tr>
        <tr>
...
<table border="1" class="tablas_form" style="padding:0px; margin:0 0 15 0; font-size:12px;" cellspacing="0" cellpadding="2" id="table_busqueda_rep">
	<thead>
		<tr>
			<th align="center" colspan="6" style="font-size: 20px;">Detalle de Notas de Credito. Periodo: <?php echo $fechaInicio_f."-".$fechaFin_f; ?></th>
        </tr>
        <tr>
			<th align="center" style="font-size: 16px;">XFOLIO</th>
			<th align="center" style="font-size: 16px;">SERIE</th>
...
<?php
	...
	$sqlAbonos = "Select 
		...
		b.TotalRetencion as RetencioNC,
