...
$sql2 = "SELECT ID, RazonSocial FROM ".$prefijobd."proveedores UNION ALL SELECT '0', 'ALL' ORDER BY RazonSocial";
...
<title>Reporte Antiguedad Saldos Proveedores</title>
<style type="text/css">
.style1 {
...
.style3 {
	...
	<body>  
	  <form action="reporte_antiguedad_saldos_pdf_proveedor.php" method="post" target="_blank">
	<div class="col-md-8 col-md-offset-2">
		<div class="row">
			<div class="col-md-12">
				<h2><b>Reporte Antiguedad Saldos por Pagar</b></h2>
			</div>
		</div>
		<br>
		<div class="row">
							...
							<option value="0">- Seleccione -</option>
								<?php 
									...
									while($row2 = mysql_fetch_array($res2)){
										$id_proveedor = $row2['ID'];
										$nom_proveedor = $row2['RazonSocial'];
								?>
