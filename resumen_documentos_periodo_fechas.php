...
<html>
  <head>
    <title>Resumen Documentos por Periodo</title>
	...
	<body>
		<div class="col-md-8 col-md-offset-2">
			<div id="encabezadoform">
			  <h1>Resumen Documentos por Periodo</h1>
			</div>
			<center>
			  <form method="post" action="resumen_documentos_periodo.php" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<input type="hidden" name="prefijobd" id="prefijobd" value='<?php echo $prefijobd; ?>'>
					<button type="submit" name="btnEnviar" id="btnEnviar" value="PDF" class="btn btn-primary">Generar Reporte</button>
